...
- `action:vs2022` - Match project generation target
...
Generate project files (CMake, Makefile, Visual Studio).

```bash
Jenga gen <generator> [options]
```
...
- `xcode`: Generate Xcode project (macOS)
