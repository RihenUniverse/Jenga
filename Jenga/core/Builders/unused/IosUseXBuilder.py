...
class XcodeProjectGenerator:
    ...
    def Generate(
        ...
        XcodeProjectGenerator._WritePbxproj(project, target_os, target_arch, is_simulator, proj_dir, target_profile)
    ...
    def _GetBuildSettings(config: str, project: Project, target_profile: Dict[str, object]) -> Dict:
        ...
        settings = {
            ...
            "SDKROOT": str(target_profile["sdk_device"]),
        ...
        if project.frameworks:
            ldflags.extend([f"-framework {fw}" for fw in project.frameworks])
