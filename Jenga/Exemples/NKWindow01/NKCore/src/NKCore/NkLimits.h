...
namespace nkentseu {
    namespace core {
        ...
        struct NkNumericLimits<nk_int8> {
            ...
            static constexpr nk_int8 min() { return NKENTSEU_INT8_MIN; }
            static constexpr nk_int8 max() { return NKENTSEU_INT8_MAX; }
            static constexpr nk_int8 lowest() { return min(); }
        ...
        struct NkNumericLimits<nk_uint8> {
            ...
            static constexpr nk_uint8 min() { return 0; }
            static constexpr nk_uint8 max() { return NKENTSEU_UINT8_MAX; }
            static constexpr nk_uint8 lowest() { return min(); }
        ...
        struct NkNumericLimits<nk_int16> {
            ...
            static constexpr nk_int16 min() { return NKENTSEU_INT16_MIN; }
            static constexpr nk_int16 max() { return NKENTSEU_INT16_MAX; }
            static constexpr nk_int16 lowest() { return min(); }
        ...
        struct NkNumericLimits<nk_uint16> {
            ...
            static constexpr nk_uint16 min() { return 0; }
            static constexpr nk_uint16 max() { return NKENTSEU_UINT16_MAX; }
            static constexpr nk_uint16 lowest() { return min(); }
        ...
        struct NkNumericLimits<nk_int32> {
            ...
            static constexpr nk_int32 min() { return NKENTSEU_INT32_MIN; }
            static constexpr nk_int32 max() { return NKENTSEU_INT32_MAX; }
            static constexpr nk_int32 lowest() { return min(); }
        ...
        struct NkNumericLimits<nk_uint32> {
            ...
            static constexpr nk_uint32 min() { return 0; }
            static constexpr nk_uint32 max() { return NKENTSEU_UINT32_MAX; }
            static constexpr nk_uint32 lowest() { return min(); }
        ...
        struct NkNumericLimits<nk_int64> {
            ...
            static constexpr nk_int64 min() { return NKENTSEU_INT64_MIN; }
            static constexpr nk_int64 max() { return NKENTSEU_INT64_MAX; }
            static constexpr nk_int64 lowest() { return min(); }
        ...
        struct NkNumericLimits<nk_uint64> {
            ...
            static constexpr nk_uint64 min() { return 0; }
            static constexpr nk_uint64 max() { return NKENTSEU_UINT64_MAX; }
            static constexpr nk_uint64 lowest() { return min(); }
