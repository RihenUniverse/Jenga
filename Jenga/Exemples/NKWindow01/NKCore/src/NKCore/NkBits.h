    ...
    namespace core {
        ...
        class NKENTSEU_CORE_API NkBits {
            public:
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static nk_int32 CountBits(T value) {
                    if (sizeof(T) == 8) return NK_POPCOUNT64(value);
                    if (sizeof(T) == 4) return NK_POPCOUNT32(value);
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static nk_int32 CountTrailingZeros(T value) {
                    if (value == 0) return sizeof(T) * 8;
                    
                    if (sizeof(T) == 8) return NK_CTZ64(value);
                    if (sizeof(T) == 4) return NK_CTZ32(value);
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static nk_int32 CountLeadingZeros(T value) {
                    if (value == 0) return sizeof(T) * 8;
                    
                    if (sizeof(T) == 8) return NK_CLZ64(value);
                    if (sizeof(T) == 4) return NK_CLZ32(value);
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static nk_int32 FindFirstSet(T value) {
                    if (value == 0) return -1;
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static nk_int32 FindLastSet(T value) {
                    if (value == 0) return -1;
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static T RotateLeft(T value, nk_int32 shift) {
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static T RotateRight(T value, nk_int32 shift) {
                    const nk_int32 bits = sizeof(T) * 8;
                    shift &= (bits - 1);  // Modulo bits
                    return (value >> shift) | (value << (bits - shift));
                }
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static nk_bool IsPowerOfTwo(T value) {
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static nk_int32 Log2(T value) {
                ...
                NKENTSEU_FORCE_INLINE static T ExtractBits(T value, nk_int32 position, nk_int32 count) {
                    NKENTSEU_ASSERT_MSG(position >= 0 && count > 0 && position + count <= sizeof(T) * 8,
                                      "Invalid bit range");
                    T mask = ((T(1) << count) - 1);
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static T ReverseBits(T value) {
                 ...
                 */
                template<typename T>
                NKENTSEU_FORCE_INLINE static T ReverseBytes(T value) {
                    if (sizeof(T) == 8) return ByteSwap64(value);
                    if (sizeof(T) == 4) return ByteSwap32(value);
                    if (sizeof(T) == 2) return ByteSwap16(value);
