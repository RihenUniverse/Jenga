...
namespace nkentseu {
    namespace core {
        ...
        struct Byte {
            ...
            // Opérateurs bitwise
            constexpr Byte operator|(Byte b) const noexcept { return Byte(value | b.value); }
            constexpr Byte operator&(Byte b) const noexcept { return Byte(value & b.value); }
            constexpr Byte operator^(Byte b) const noexcept { return Byte(value ^ b.value); }
            constexpr Byte operator~() const noexcept { return Byte(~value); }
            
            template<typename T>
            constexpr Byte operator<<(T shift) const noexcept { return Byte(value << shift); }
             ...
             */
            template<typename T>
            static constexpr Byte from(T v) noexcept { return Byte(static_cast<uint8>(v)); }
        ...
        // Support optionnel pour les types 128 bits
            ...
            struct int128 { int64 low; int64 high; };
            struct uint128 { uint64 low; uint64 high; };
        #endif
         ...
         */
        template<typename T>
        inline T* SafeConstCast(ConstVoidPtr ptr) noexcept {
            return (T*)ptr;
        }
         ...
         */
        template<typename T>
        inline T* NkSafeCast(VoidPtr ptr) noexcept {
            return (T*)ptr;
        }
...
// ============================================================
namespace nkentseu {
    using core::int8;   using core::uint8;
    using core::int16;  using core::uint16;
    using core::int32;  using core::uint32;
    using core::int64;  using core::uint64;
    using core::float32; using core::float64;
    using core::bool32;  using core::Boolean;
    using core::nk_uint8; using core::nk_uint16;
    using core::nk_uint32; using core::nk_uint64;
    using core::nk_int8; using core::nk_int16;
    using core::nk_int32; using core::nk_int64;
    using core::nk_bool; using core::nk_char;
    using core::nk_size; using core::usize;
}
