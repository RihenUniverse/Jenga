...
namespace nkentseu {
    namespace platform {
         ...
         */
        template<typename T>
        NK_FORCEINLINE constexpr T ByteSwap(T value) {
            static_assert(sizeof(T) == 2 || sizeof(T) == 4 || sizeof(T) == 8,
                         "ByteSwap only supports 2, 4, or 8 byte types");
            
            if constexpr (sizeof(T) == 2) {
                union { T val; uint16_t u16; } u;
                u.val = value;
                u.u16 = ByteSwap16(u.u16);
                return u.val;
            } else if constexpr (sizeof(T) == 4) {
                union { T val; uint32_t u32; } u;
                u.val = value;
                u.u32 = ByteSwap32(u.u32);
                return u.val;
            } else if constexpr (sizeof(T) == 8) {
                union { T val; uint64_t u64; } u;
                u.val = value;
         ...
         */
        template<typename T>
        NK_FORCEINLINE constexpr T ToLittleEndian(T value) {
            #if NK_LITTLE_ENDIAN
                return value;
            #else
         ...
         */
        template<typename T>
        NK_FORCEINLINE constexpr T FromLittleEndian(T value) {
         ...
         */
        template<typename T>
        NK_FORCEINLINE constexpr T ToBigEndian(T value) {
            #if NK_BIG_ENDIAN
                return value;
            #else
                return ByteSwap(value);
         ...
         */
        template<typename T>
        NK_FORCEINLINE constexpr T FromBigEndian(T value) {
         ...
         */
        template<typename T>
        inline void ByteSwapBuffer(T* data, size_t count) {
         ...
         */
        template<typename T>
        inline void BufferToLittleEndian(T* data, size_t count) {
            #if !NK_LITTLE_ENDIAN
         ...
         */
        template<typename T>
        inline void BufferFromLittleEndian(T* data, size_t count) {
         ...
         */
        template<typename T>
        inline void BufferToBigEndian(T* data, size_t count) {
            #if !NK_BIG_ENDIAN
                ByteSwapBuffer(data, count);
            #endif
        }
         ...
         */
        template<typename T>
        inline void BufferFromBigEndian(T* data, size_t count) {
