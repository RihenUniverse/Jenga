...
public:
    ...
    NkVec2u     GetPosition()            const override { return {}; } ///< Wayland n'expose pas la position
    ...
    void SetPosition(NkI32, NkI32)           override {} ///< no-op sous Wayland
    ...
    void SetProgress(float)                  override {} ///< non supporté

    // --- Surface de rendu ---------------------------------------------------
    NkSurfaceDesc GetSurfaceDesc()       const override;

    // --- Accès natifs -------------------------------------------------------
    wl_display*  GetWlDisplay()  const { return mData.display;  }
    wl_surface*  GetWlSurface()  const { return mData.surface;  }
    bool         WantsClose()    const { return mData.wantsClose; }
    void         ClearClose()          { mData.wantsClose = false; }
...
private:
    ...
    // Registre global
    static void OnRegistryGlobal(void* data, wl_registry* reg,
    ...
    static void OnXdgToplevelConfigure(void* data, xdg_toplevel* tl,
