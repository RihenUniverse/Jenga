...
#define NkCurrentSourceLocation \
    nkentseu::core::platform::MkSourceLocation::Current( \
        NKENTSEU_BUILTIN_FILE, \
        NKENTSEU_BUILTIN_FUNCTION, \
        NKENTSEU_BUILTIN_LINE, \
        NKENTSEU_BUILTIN_COLUMN)

#define NkCurrentLocation() nkentseu::core::NkSourceLocation::Current(NKENTSEU_BUILTIN_FILE, __FUNCTION__, NKENTSEU_BUILTIN_LINE, NKENTSEU_BUILTIN_COLUMN)
 ...
 * @ingroup PlatformAPI
 */
NKENTSEU_CORE_C_API nkentseu::core::nk_bool NkIsAligned(const nkentseu::core::nk_ptr address, nkentseu::core::nk_size alignment);
 ...
 * @ingroup PlatformAPI
 */
NKENTSEU_CORE_C_API nkentseu::core::nk_ptr NkAlignAddress(nkentseu::core::nk_ptr address, nkentseu::core::nk_size alignment);
 ...
 * @ingroup PlatformAPI
 */
NKENTSEU_CORE_C_API const nkentseu::core::nk_ptr NkAlignAddressConst(const nkentseu::core::nk_ptr address, nkentseu::core::nk_size alignment);
    ...
    namespace core {
        namespace platform {
            ...
            namespace memory {
                ...
                inline T* NkConstructAligned(core::nk_ptr ptr, Args&&... args) noexcept {
 ...
 */
#define NkAllocAligned(size) \
    nkentseu::core::platform::memory::NkAllocateAligned((size), NKENTSEU_CACHE_LINE_SIZE)

/**
 * @brief Alloue mémoire alignée sur page
 */
#define NkAllocPageAligned(size) \
    nkentseu::core::platform::memory::NkAllocateAligned((size), NKENTSEU_PAGE_SIZE)

/**
 * @brief Libère mémoire alignée
 */
#define NkFreeAligned(ptr) \
    nkentseu::core::platform::memory::NkFreeAligned(ptr)
