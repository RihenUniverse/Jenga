...
namespace nkentseu {
    namespace core {
        namespace literals {
             ...
             */
            constexpr nk_uint8 operator""_u8(unsigned long long val) { return static_cast<nk_uint8>(val); }
            
            /**
             * @brief Literal pour uint16
             */
            constexpr nk_uint16 operator""_u16(unsigned long long val) { return static_cast<nk_uint16>(val); }
            
            /**
             * @brief Literal pour uint32
             */
            constexpr nk_uint32 operator""_u32(unsigned long long val) { return static_cast<nk_uint32>(val); }
            
            /**
             * @brief Literal pour uint64
             */
            constexpr nk_uint64 operator""_u64(unsigned long long val) { return static_cast<nk_uint64>(val); }
            
            /**
             * @brief Literal pour int8
             */
            constexpr nk_int8 operator""_i8(unsigned long long val) { return static_cast<nk_int8>(val); }
            
            /**
             * @brief Literal pour int16
             */
            constexpr nk_int16 operator""_i16(unsigned long long val) { return static_cast<nk_int16>(val); }
            
            /**
             * @brief Literal pour int32
             */
            constexpr nk_int32 operator""_i32(unsigned long long val) { return static_cast<nk_int32>(val); }
            
            /**
             * @brief Literal pour int64
             */
            constexpr nk_int64 operator""_i64(unsigned long long val) { return static_cast<nk_int64>(val); }
            
            /**
             * @brief Literal pour float32
             */
            constexpr nk_float32 operator""_f32(long double val) { return static_cast<nk_float32>(val); }
            
            /**
             * @brief Literal pour float64
             */
            constexpr nk_float64 operator""_f64(long double val) { return static_cast<nk_float64>(val); }
            
            /**
             * @brief Literal pour float80
             */
            constexpr nk_float80 operator""_f80(long double val) { return static_cast<nk_float80>(val); }
            
            /**
             * @brief Literal pour bool32
             */
            constexpr nk_bool32 operator""_b32(unsigned long long val) { return static_cast<nk_bool32>(val); }
            
            /**
             * @brief Literal pour nkchar
             */
            constexpr nk_char operator""_cb(char c) { return static_cast<nk_char>(c); }
            
            /**
             * @brief Literal pour char8
             */
            constexpr nk_char8 operator""_c8(char c) { return static_cast<nk_char8>(c); }
            
            /**
             * @brief Literal pour char16
             */
            constexpr nk_char16 operator""_c16(unsigned long long val) { return static_cast<nk_char16>(val); }
            
            /**
             * @brief Literal pour char32
             */
            constexpr nk_char32 operator""_c32(unsigned long long val) { return static_cast<nk_char32>(val); }
            
            #if defined(_WIN32) || defined(_WIN64)
                /**
                 * @brief Literal pour wchar (Windows)
                 */
                constexpr nk_wchar operator""_cw(nk_wchar val) { return static_cast<nk_wchar>(val); }
            #endif
                 ...
                 */
                constexpr nk_uint128 operator""_u128(unsigned long long val) { return static_cast<nk_uint128>(val); }
                
                /**
                 * @brief Literal pour int128
                 */
                constexpr nk_int128 operator""_i128(unsigned long long val) { return static_cast<nk_int128>(val); }
            #endif
