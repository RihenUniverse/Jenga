...
// =============================================================================
// NkWin32DropTarget.h
// IDropTarget COM pour Win32 â€” Drag & Drop OLE (fichiers + texte).
//
// EnregistrÃ© via RegisterDragDrop(hwnd, &target) dans NkWin32EventImpl::Initialize
...
public:
	...
	// Callbacks appelÃ©s sur les Ã©vÃ©nements drop
	...
	HRESULT STDMETHODCALLTYPE Drop(IDataObject *pData, DWORD /*grfKeyState*/, POINTL pt, DWORD *pdwEffect) override {
		POINT cp = {pt.x, pt.y};
		ScreenToClient(mHwnd, &cp);
