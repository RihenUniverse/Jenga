...
public:
	...
	NkRenderer(Window &window, std::unique_ptr<INkRendererImpl> externalImpl, const NkRendererConfig &config = {});
	~NkRenderer();
	...
	bool Create(Window &window, std::unique_ptr<INkRendererImpl> externalImpl, const NkRendererConfig &config = {});
