...
struct NkTouchData {
	...
	std::string ToString() const {
		return "Touch(" + std::to_string(numTouches) + " contacts, centroid=" + std::to_string(centroidX) + "," +
...
struct NkGesturePinchData {
	...
	std::string ToString() const {
		return "GesturePinch(scale=" + std::to_string(scale) + " delta=" + std::to_string(scaleDelta) +
...
struct NkGesturePanData {
	...
	std::string ToString() const {
		return "GesturePan(dx=" + std::to_string(deltaX) + " dy=" + std::to_string(deltaY) +
...
struct NkGestureSwipeData {
	...
	std::string ToString() const {
		...
		return std::string("GestureSwipe(") + d + " speed=" + std::to_string(speed) +
			   " fingers=" + std::to_string(numFingers) + ")";
	}
};
...
struct NkGestureTapData {
	...
	std::string ToString() const {
		return "GestureTap(count=" + std::to_string(tapCount) + " fingers=" + std::to_string(numFingers) + " at " +
...
struct NkGestureLongPressData {
	...
	std::string ToString() const {
		return "GestureLongPress(" + std::to_string(durationMs) + "ms" + " at " + std::to_string(x) + "," +
			   std::to_string(y) + ")";
	}
};
