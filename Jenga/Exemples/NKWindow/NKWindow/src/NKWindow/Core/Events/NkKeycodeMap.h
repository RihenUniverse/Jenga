...
inline NkKey NkKeycodeMap::NkKeyFromWin32VK(NkU32 vk, bool extended) {
	switch (vk) {
		...
		case 0x10:
			return NkKey::NK_LSHIFT; // VK_SHIFT (indistinct -> gauche)
		case 0x11:
		...
		case 0x6E:
			return NkKey::NK_NUMPAD_DOT;
		case 0x6F:
			return extended ? NkKey::NK_NUMPAD_DIV : NkKey::NK_NUMPAD_DIV;
		// F1-F24
		case 0x70:
			return NkKey::NK_F1;
		case 0x71:
		...
		// OEM
		case 0xBA:
			return NkKey::NK_SEMICOLON; // ;: (US)
		case 0xBB:
			return NkKey::NK_EQUALS; // =+
		case 0xBC:
			return NkKey::NK_COMMA; // ,<
		case 0xBD:
			return NkKey::NK_MINUS; // -_
		case 0xBE:
			return NkKey::NK_PERIOD; // .>
		case 0xBF:
			return NkKey::NK_SLASH; // /?
...
inline NkKey NkKeycodeMap::NkKeyFromMacKeyCode(NkU16 kc) {
	switch (kc) {
		...
		case 0x35:
			return NkKey::NK_ESCAPE;
		case 0x37:
			return NkKey::NK_LSUPER; // Cmd gauche
		case 0x38:
			return NkKey::NK_LSHIFT;
		case 0x39:
			return NkKey::NK_CAPSLOCK;
		...
		case 0x3E:
			return NkKey::NK_RCTRL;
		case 0x3F:
			return NkKey::NK_LSUPER; // Fn (traité comme super)
		case 0x40:
			return NkKey::NK_F17;
		case 0x41:
			return NkKey::NK_NUMPAD_DOT;
...
inline NkKey NkKeycodeMap::NkKeyFromDomCode(const char *code) {
	...
	struct {
		const char *code;
		NkKey key;
	} table[] = {{"Backquote", NkKey::NK_GRAVE},
...
inline NkKey NkKeycodeMap::NkKeyFromAndroid(NkU32 kc) {
	...
	switch (kc) {
		case 4:
			return NkKey::NK_BACK; // AKEYCODE_BACK
		case 7:
			return NkKey::NK_NUM0; // AKEYCODE_0
		case 8:
			return NkKey::NK_NUM1;
		case 9:
			return NkKey::NK_NUM2;
		...
		case 16:
			return NkKey::NK_NUM9;
		case 17:
			return NkKey::NK_NUMPAD_MUL; // AKEYCODE_STAR
		case 19:
			return NkKey::NK_UP;
		case 20:
			return NkKey::NK_DOWN;
		...
		case 76:
			return NkKey::NK_SLASH;
		case 77:
			return NkKey::NK_MENU; // AKEYCODE_AT -> menu
		case 81:
			return NkKey::NK_NUMPAD_ADD; // AKEYCODE_PLUS
		case 82:
			return NkKey::NK_MENU;
		case 84:
			return NkKey::NK_BROWSER_SEARCH;
