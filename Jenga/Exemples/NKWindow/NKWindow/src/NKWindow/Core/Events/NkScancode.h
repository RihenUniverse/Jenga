...
enum class NkScancode : NkU32
{
    ...
    NK_SC_A = 0x04,   NK_SC_B = 0x05,   NK_SC_C = 0x06,   NK_SC_D = 0x07,
    NK_SC_E = 0x08,   NK_SC_F = 0x09,   NK_SC_G = 0x0A,   NK_SC_H = 0x0B,
    NK_SC_I = 0x0C,   NK_SC_J = 0x0D,   NK_SC_K = 0x0E,   NK_SC_L = 0x0F,
    NK_SC_M = 0x10,   NK_SC_N = 0x11,   NK_SC_O = 0x12,   NK_SC_P = 0x13,
    NK_SC_Q = 0x14,   NK_SC_R = 0x15,   NK_SC_S = 0x16,   NK_SC_T = 0x17,
    NK_SC_U = 0x18,   NK_SC_V = 0x19,   NK_SC_W = 0x1A,   NK_SC_X = 0x1B,
    NK_SC_Y = 0x1C,   NK_SC_Z = 0x1D,

    // ---[ 0x1E–0x27 : Chiffres 1–0 ligne du haut ]---------------------------
    NK_SC_1 = 0x1E,   NK_SC_2 = 0x1F,   NK_SC_3 = 0x20,   NK_SC_4 = 0x21,
    NK_SC_5 = 0x22,   NK_SC_6 = 0x23,   NK_SC_7 = 0x24,   NK_SC_8 = 0x25,
    NK_SC_9 = 0x26,   NK_SC_0 = 0x27,
    ...
    NK_SC_F1  = 0x3A,  NK_SC_F2  = 0x3B,  NK_SC_F3  = 0x3C,  NK_SC_F4  = 0x3D,
    NK_SC_F5  = 0x3E,  NK_SC_F6  = 0x3F,  NK_SC_F7  = 0x40,  NK_SC_F8  = 0x41,
    NK_SC_F9  = 0x42,  NK_SC_F10 = 0x43,  NK_SC_F11 = 0x44,  NK_SC_F12 = 0x45,
    ...
    NK_SC_NUMPAD_1     = 0x59,  NK_SC_NUMPAD_2  = 0x5A,  NK_SC_NUMPAD_3 = 0x5B,
    NK_SC_NUMPAD_4     = 0x5C,  NK_SC_NUMPAD_5  = 0x5D,  NK_SC_NUMPAD_6 = 0x5E,
    NK_SC_NUMPAD_7     = 0x5F,  NK_SC_NUMPAD_8  = 0x60,  NK_SC_NUMPAD_9 = 0x61,
    NK_SC_NUMPAD_0     = 0x62,
    ...
    // ---[ 0x68–0x6F : F13–F24 ]----------------------------------------------
    NK_SC_F13 = 0x68,  NK_SC_F14 = 0x69,  NK_SC_F15 = 0x6A,  NK_SC_F16 = 0x6B,
    NK_SC_F17 = 0x6C,  NK_SC_F18 = 0x6D,  NK_SC_F19 = 0x6E,  NK_SC_F20 = 0x6F,
    NK_SC_F21 = 0x70,  NK_SC_F22 = 0x71,  NK_SC_F23 = 0x72,  NK_SC_F24 = 0x73,
...
inline const char* NkScancodeToString(NkScancode sc)
{
    ...
    case NkScancode::NK_SC_NONUS_BACKSLASH: return "SC_NONUS_BACKSLASH";
...
inline NkScancode NkScancodeFromMac(NkU32 kc)
{
    ...
    case 0x3F: return NkScancode::NK_SC_APPLICATION; // Fn
    ...
    case 0x47: return NkScancode::NK_SC_NUM_LOCK;  // Clear sur Mac
...
inline NkScancode NkScancodeFromDOMCode(const char* code)
{
    ...
    case 'K': // Key*
        ...
        {
            char c = code[3];
            if (c=='A') return NkScancode::NK_SC_A;
            if (c=='B') return NkScancode::NK_SC_B;
            if (c=='C') return NkScancode::NK_SC_C;
            if (c=='D') return NkScancode::NK_SC_D;
            if (c=='E') return NkScancode::NK_SC_E;
            if (c=='F') return NkScancode::NK_SC_F;
            if (c=='G') return NkScancode::NK_SC_G;
            if (c=='H') return NkScancode::NK_SC_H;
            if (c=='I') return NkScancode::NK_SC_I;
            if (c=='J') return NkScancode::NK_SC_J;
            if (c=='K') return NkScancode::NK_SC_K;
            if (c=='L') return NkScancode::NK_SC_L;
            if (c=='M') return NkScancode::NK_SC_M;
            if (c=='N') return NkScancode::NK_SC_N;
            if (c=='O') return NkScancode::NK_SC_O;
            if (c=='P') return NkScancode::NK_SC_P;
            if (c=='Q') return NkScancode::NK_SC_Q;
            if (c=='R') return NkScancode::NK_SC_R;
            if (c=='S') return NkScancode::NK_SC_S;
            if (c=='T') return NkScancode::NK_SC_T;
            if (c=='U') return NkScancode::NK_SC_U;
            if (c=='V') return NkScancode::NK_SC_V;
            if (c=='W') return NkScancode::NK_SC_W;
            if (c=='X') return NkScancode::NK_SC_X;
            if (c=='Y') return NkScancode::NK_SC_Y;
            if (c=='Z') return NkScancode::NK_SC_Z;
        }
        break;
    ...
    case 'D': // Digit* or Delete/End...
        ...
        {
            char c = code[5];
            if (c=='1') return NkScancode::NK_SC_1;
            if (c=='2') return NkScancode::NK_SC_2;
            if (c=='3') return NkScancode::NK_SC_3;
            if (c=='4') return NkScancode::NK_SC_4;
            if (c=='5') return NkScancode::NK_SC_5;
            if (c=='6') return NkScancode::NK_SC_6;
            if (c=='7') return NkScancode::NK_SC_7;
            if (c=='8') return NkScancode::NK_SC_8;
            if (c=='9') return NkScancode::NK_SC_9;
            if (c=='0') return NkScancode::NK_SC_0;
        }
        if (code[1]=='e')
        {
            if (code[2]=='l') return NkScancode::NK_SC_DELETE;   // Delete
        }
        break;
    ...
    case 'N': // Numpad* or NumLock
        ...
        {
            const char* k = code+6;
            if (k[0]=='0') return NkScancode::NK_SC_NUMPAD_0;
            if (k[0]=='1') return NkScancode::NK_SC_NUMPAD_1;
            if (k[0]=='2') return NkScancode::NK_SC_NUMPAD_2;
            if (k[0]=='3') return NkScancode::NK_SC_NUMPAD_3;
            if (k[0]=='4') return NkScancode::NK_SC_NUMPAD_4;
            if (k[0]=='5') return NkScancode::NK_SC_NUMPAD_5;
            if (k[0]=='6') return NkScancode::NK_SC_NUMPAD_6;
            if (k[0]=='7') return NkScancode::NK_SC_NUMPAD_7;
            if (k[0]=='8') return NkScancode::NK_SC_NUMPAD_8;
            if (k[0]=='9') return NkScancode::NK_SC_NUMPAD_9;
            if (k[0]=='D' && k[1]=='e' && k[2]=='c') return NkScancode::NK_SC_NUMPAD_DOT;
            if (k[0]=='E' && k[1]=='n') return NkScancode::NK_SC_NUMPAD_ENTER;
            if (k[0]=='A' && k[1]=='d') return NkScancode::NK_SC_NUMPAD_ADD;
            if (k[0]=='S' && k[1]=='u') return NkScancode::NK_SC_NUMPAD_SUB;
            if (k[0]=='M' && k[1]=='u') return NkScancode::NK_SC_NUMPAD_MUL;
            if (k[0]=='D' && k[1]=='i') return NkScancode::NK_SC_NUMPAD_DIV;
            if (k[0]=='E' && k[1]=='q') return NkScancode::NK_SC_NUMPAD_EQUALS;
        }
        if (code[1]=='u' && code[2]=='m' && code[3]=='L') return NkScancode::NK_SC_NUM_LOCK;
        break;
    ...
    case 'F': // F1..F24
        ...
        {
            int fn = 0;
            if (code[2] == 0) fn = code[1] - '0';
            else fn = (code[1]-'0')*10 + (code[2]-'0');
            switch (fn)
            {
            case 1:  return NkScancode::NK_SC_F1;  case 2:  return NkScancode::NK_SC_F2;
            case 3:  return NkScancode::NK_SC_F3;  case 4:  return NkScancode::NK_SC_F4;
            case 5:  return NkScancode::NK_SC_F5;  case 6:  return NkScancode::NK_SC_F6;
            case 7:  return NkScancode::NK_SC_F7;  case 8:  return NkScancode::NK_SC_F8;
            case 9:  return NkScancode::NK_SC_F9;  case 10: return NkScancode::NK_SC_F10;
            case 11: return NkScancode::NK_SC_F11; case 12: return NkScancode::NK_SC_F12;
            case 13: return NkScancode::NK_SC_F13; case 14: return NkScancode::NK_SC_F14;
            case 15: return NkScancode::NK_SC_F15; case 16: return NkScancode::NK_SC_F16;
            case 17: return NkScancode::NK_SC_F17; case 18: return NkScancode::NK_SC_F18;
            case 19: return NkScancode::NK_SC_F19; case 20: return NkScancode::NK_SC_F20;
            case 21: return NkScancode::NK_SC_F21; case 22: return NkScancode::NK_SC_F22;
            case 23: return NkScancode::NK_SC_F23; case 24: return NkScancode::NK_SC_F24;
            }
        }
        break;
    ...
    case 'A': // Arrow*, Alt*
        ...
        {
            if (code[5]=='L') return NkScancode::NK_SC_LEFT;
            if (code[5]=='R') return NkScancode::NK_SC_RIGHT;
            if (code[5]=='U') return NkScancode::NK_SC_UP;
            if (code[5]=='D') return NkScancode::NK_SC_DOWN;
        }
        if (code[1]=='l' && code[2]=='t')
        {
            if (code[3]=='L') return NkScancode::NK_SC_LALT;
            if (code[3]=='R') return NkScancode::NK_SC_RALT;
        }
        break;

    case 'S': // Space, Shift*, ScrollLock
        if (code[1]=='p') return NkScancode::NK_SC_SPACE;
        if (code[1]=='h' && code[2]=='i' && code[3]=='f' && code[4]=='t')
        {
            if (code[5]=='L') return NkScancode::NK_SC_LSHIFT;
            if (code[5]=='R') return NkScancode::NK_SC_RSHIFT;
        }
        if (code[1]=='c') return NkScancode::NK_SC_SCROLL_LOCK; // ScrollLock
        break;

    case 'C': // Control*, CapsLock
        if (code[1]=='o' && code[2]=='n' && code[3]=='t' && code[4]=='r')
        {
            if (code[7]=='L') return NkScancode::NK_SC_LCTRL;
            if (code[7]=='R') return NkScancode::NK_SC_RCTRL;
        }
        if (code[1]=='a') return NkScancode::NK_SC_CAPS_LOCK;
        break;

    case 'M': // Meta*, MediaPlay...
        if (code[1]=='e' && code[2]=='t' && code[3]=='a')
        {
            if (code[4]=='L') return NkScancode::NK_SC_LSUPER;
            if (code[4]=='R') return NkScancode::NK_SC_RSUPER;
        }
        if (code[1]=='e' && code[2]=='d' && code[3]=='i') return NkScancode::NK_SC_UNKNOWN;
        break;

    case 'E': // Enter, End
        if (code[1]=='n' && code[2]=='t') return NkScancode::NK_SC_ENTER;
        if (code[1]=='n' && code[2]=='d') return NkScancode::NK_SC_END;
        if (code[1]=='s') return NkScancode::NK_SC_ESCAPE;
        break;

    case 'B': // Backspace, BackquoteIntlBackslash
        if (code[1]=='a' && code[2]=='c' && code[3]=='k' && code[4]=='s') return NkScancode::NK_SC_BACKSPACE;
        if (code[1]=='a' && code[2]=='c' && code[3]=='k' && code[4]=='q') return NkScancode::NK_SC_GRAVE;
        if (code[1]=='r') return NkScancode::NK_SC_UNKNOWN; // BrowserXxx
        break;

    case 'T': // Tab
        if (code[1]=='a') return NkScancode::NK_SC_TAB;
        break;

    case 'P': // PageUp, PageDown, PrintScreen, Pause
        if (code[1]=='a' && code[2]=='g' && code[3]=='e')
        {
            if (code[4]=='U') return NkScancode::NK_SC_PAGE_UP;
            if (code[4]=='D') return NkScancode::NK_SC_PAGE_DOWN;
        }
        if (code[1]=='r' && code[2]=='i') return NkScancode::NK_SC_PRINT_SCREEN;
        if (code[1]=='a' && code[2]=='u') return NkScancode::NK_SC_PAUSE;
        break;

    case 'H': // Home
        if (code[1]=='o') return NkScancode::NK_SC_HOME;
        break;

    case 'I': // Insert
        if (code[1]=='n' && code[2]=='s') return NkScancode::NK_SC_INSERT;
        break;

    case 'Q': // Quote, etc.
        if (code[1]=='u' && code[2]=='o') return NkScancode::NK_SC_APOSTROPHE;
        break;
    ...
    // Touches ponctuelles
    struct { const char* dom; NkScancode sc; } kExtra[] = {
