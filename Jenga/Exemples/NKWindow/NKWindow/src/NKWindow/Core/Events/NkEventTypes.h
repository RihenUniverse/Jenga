...
inline const char *NkButtonStateToString(NkButtonState s) {
	switch (s) {
		case NkButtonState::NK_PRESSED:
			return "PRESSED";
		case NkButtonState::NK_RELEASED:
			return "RELEASED";
		case NkButtonState::NK_REPEAT:
			return "REPEAT";
		default:
			return "UNKNOWN";
	}
...
enum class NkWindowTheme : NkU32 { NK_THEME_UNKNOWN = 0, NK_THEME_LIGHT, NK_THEME_DARK, NK_THEME_HIGH_CONTRAST };
...
enum class NkSwipeDirection : NkU32 { NK_SWIPE_NONE = 0, NK_SWIPE_LEFT, NK_SWIPE_RIGHT, NK_SWIPE_UP, NK_SWIPE_DOWN };
