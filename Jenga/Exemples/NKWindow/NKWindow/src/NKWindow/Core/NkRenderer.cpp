...
NkRenderer::NkRenderer(Window &window, std::unique_ptr<INkRendererImpl> externalImpl, const NkRendererConfig &config) {
...
bool NkRenderer::Create(Window &window, std::unique_ptr<INkRendererImpl> externalImpl, const NkRendererConfig &config) {
	Shutdown();
