...
bool          NkSoftwareRendererImpl::IsValid()               const { return mReady;                     }
NkRendererApi NkSoftwareRendererImpl::GetApi()                const { return NkRendererApi::NK_SOFTWARE;  }
std::string   NkSoftwareRendererImpl::GetApiName()            const { return "Software";                  }
bool          NkSoftwareRendererImpl::IsHardwareAccelerated() const { return false;                       }
NkError       NkSoftwareRendererImpl::GetLastError()          const { return mLastError;                  }
const NkFramebufferInfo& NkSoftwareRendererImpl::GetFramebufferInfo() const { return mFbInfo; }

// ---------------------------------------------------------------------------
// Couleur de fond
// ---------------------------------------------------------------------------

void  NkSoftwareRendererImpl::SetBackgroundColor(NkU32 rgba) { mBgColor = rgba; }
NkU32 NkSoftwareRendererImpl::GetBackgroundColor()     const { return mBgColor; }
