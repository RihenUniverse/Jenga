...
// =============================================================================
// NkWindowsDesktop.h
// Point d'entrée Win32 Desktop.
// Analyse CommandLineToArgvW, crée NkEntryState, appelle nkmain().
// =============================================================================
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    // --- Récupération des arguments CLI (UTF-8) ---
    int argc = 0;
    ...
    {
        int sz = WideCharToMultiByte(CP_UTF8, 0, wargv[i], -1,
