...
int main(int argc, char* argv[])
{
    @autoreleasepool
    {
        ...
        g_ios_args.version  = [[bundle objectForInfoDictionaryKey:@"CFBundleShortVersionString"]
                                description].UTF8String ?: "1.0";
        g_ios_args.build    = [[bundle objectForInfoDictionaryKey:@"CFBundleVersion"]
        ...
        return UIApplicationMain(argc, argv, nil,
                                 NSStringFromClass([NkUIAppDelegate class]));
    }
}
