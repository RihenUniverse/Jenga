// =============================================================================
// NkSystem.cpp — cycle de vie global : EventImpl + GamepadSystem
// =============================================================================
...
bool NkSystem::Initialise(const NkAppData& data)
{
    ...
    // --- EventImpl (une seule instance) ---
    mEventImpl = std::make_unique<PlatformEventImpl>();
    EventSystem::Instance().AttachImpl(mEventImpl.get());
...
void NkSystem::Close()
{
    ...
    if (mEventImpl)
        EventSystem::Instance().DetachImpl(mEventImpl.get());
    mEventImpl.reset();
