...
// =============================================================================
// NkNkRenderer.h
// Classe publique NkRenderer — façade PIMPL vers NkIRendererImpl.
//
// Usage :
...
public:
    ...
    NkIRendererImpl*       GetImpl()       { return mImpl.get(); }
    const NkIRendererImpl* GetImpl() const { return mImpl.get(); }

private:
    std::unique_ptr<NkIRendererImpl> mImpl;
