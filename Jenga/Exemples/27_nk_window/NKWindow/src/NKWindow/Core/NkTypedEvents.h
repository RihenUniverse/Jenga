...
public:
    NK_ENSURE_COPYABLE(NkWindowCreateEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowCloseEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowResizeEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowFocusLostEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowMinimizeEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowMaximizeEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowRestoreEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowFullscreenEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowWindowedEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowDpiEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowThemeEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowShownEvent)
...
public:
    NK_ENSURE_COPYABLE(NkWindowHiddenEvent)
...
public:
    NK_ENSURE_COPYABLE(NkKeyPressEvent)
    static constexpr NkEventType TYPE = NkEventType::NK_KEY_PRESS;
...
public:
    NK_ENSURE_COPYABLE(NkKeyReleaseEvent)
...
public:
    NK_ENSURE_COPYABLE(NkKeyRepeatEvent)
...
public:
    NK_ENSURE_COPYABLE(NkTextInputEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseMoveEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseRawEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseButtonEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseButtonPressEvent)
    static constexpr NkEventType TYPE = NkEventType::NK_MOUSE_BUTTON_PRESS;
...
public:
    NK_ENSURE_COPYABLE(NkMouseButtonReleaseEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseDoubleClickEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseWheelVerticalEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseWheelHorizontalEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseEnterEvent)
...
public:
    NK_ENSURE_COPYABLE(NkMouseLeaveEvent)
...
public:
    NK_ENSURE_COPYABLE(NkTouchEvent)
...
public:
    NK_ENSURE_COPYABLE(NkTouchBeginEvent)
    static constexpr NkEventType TYPE = NkEventType::NK_TOUCH_BEGIN;
    NkU32 GetNumTouches() const { return data.touch.numTouches; }
    const NkTouchPoint& GetTouch(NkU32 i) const { return data.touch.touches[i]; }
    float GetCentroidX()  const { return data.touch.centroidX; }
...
public:
    NK_ENSURE_COPYABLE(NkTouchMoveEvent)
...
public:
    NK_ENSURE_COPYABLE(NkTouchEndEvent)
...
public:
    NK_ENSURE_COPYABLE(NkTouchCancelEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGesturePinchEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGestureRotateEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGesturePanEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGestureSwipeEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGestureTapEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGestureLongPressEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGamepadConnectEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGamepadDisconnectEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGamepadButtonEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGamepadButtonPressEvent)
    static constexpr NkEventType TYPE = NkEventType::NK_GAMEPAD_BUTTON_PRESS;
...
public:
    NK_ENSURE_COPYABLE(NkGamepadButtonReleaseEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGamepadAxisEvent)
...
public:
    NK_ENSURE_COPYABLE(NkGamepadRumbleEvent)
...
public:
    NK_ENSURE_COPYABLE(NkDropEnterEvent)
...
public:
    NK_ENSURE_COPYABLE(NkDropOverEvent)
...
public:
    NK_ENSURE_COPYABLE(NkDropTextEvent)
...
public:
    NK_ENSURE_COPYABLE(NkDropImageEvent)
...
public:
    NK_ENSURE_COPYABLE(NkSystemPowerEvent)
...
public:
    NK_ENSURE_COPYABLE(NkSystemPowerSuspendEvent)
    static constexpr NkEventType TYPE = NkEventType::NK_SYSTEM_POWER_SUSPEND;
    float GetBatteryLevel() const { return data.systemPower.batteryLevel; }
    bool  IsPluggedIn()     const { return data.systemPower.pluggedIn;    }
};
...
public:
    NK_ENSURE_COPYABLE(NkSystemPowerResumeEvent)
...
public:
    NK_ENSURE_COPYABLE(NkSystemLowMemoryEvent)
...
public:
    NK_ENSURE_COPYABLE(NkSystemDisplayEvent)
...
public:
    NK_ENSURE_COPYABLE(NkSystemMemoryEvent)
    static constexpr NkEventType TYPE = NkEventType::NK_SYSTEM_LOW_MEMORY;
    NkSystemMemoryData::Level GetLevel()        const { return data.systemMemory.level;          }
    NkU64                     GetAvailableBytes()const { return data.systemMemory.availableBytes; }
    bool IsCritical() const { return data.systemMemory.level == NkSystemMemoryData::Level::Critical; }
...
public:
    NK_ENSURE_COPYABLE(NkCustomEvent)
