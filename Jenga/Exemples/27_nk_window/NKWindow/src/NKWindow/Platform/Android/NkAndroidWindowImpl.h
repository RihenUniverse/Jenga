...
public:
    ...
    ~NkAndroidWindowImpl() override { if (mIsOpen) Close(); }
    ...
    NkVec2u     GetDisplaySize()     const override { return GetSize(); }
    NkVec2u     GetDisplayPosition() const override { return {}; }
    NkError     GetLastError()       const override { return mLastError; }

    void SetSize(NkU32,NkU32)          override {} // plein écran forcé
    ...
    ANativeWindow* GetNativeWindow() const { return mNativeWindow; }
