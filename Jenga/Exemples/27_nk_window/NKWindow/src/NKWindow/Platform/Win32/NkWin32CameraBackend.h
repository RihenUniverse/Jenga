...
public:
    ...
    bool CapturePhotoToFile(const std::string& path) override
    {
        ...
        // Écrire PNG directement via stbi (inclus dans NkCameraSystem.cpp)
        // → Appeler stbi_write_png directement ici nécessite l'include
        // Solution propre : écrire dans un fichier temporaire .ppm (portabie)
