...
public:
    ...
    void QueuePending(const nkentseu::NkEvent& event) { mPending.push(event); }
...
{
public:
    explicit ScopedEventImplAttach(TestEventImpl& impl)
        : mEs(nkentseu::EventSystem::Instance()), mImpl(impl)
    {
