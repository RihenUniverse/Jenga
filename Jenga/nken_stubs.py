"""
Nken Build System API Stub File
This file provides type hints for IDE auto-completion in .nken files

Usage:
  In your .nken file, add at the top:
  # type: ignore
  from nken_stubs import *
